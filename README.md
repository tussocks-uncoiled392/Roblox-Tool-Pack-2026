...
XCutors is a collection of Roblox script executors for Windows desktop.

### Is XCutors safe to use?

Yes, XCutors is designed to be secure and does not contain tool or components.

### Which executors are included?

Volt, Synapse Z, Potassium, Wave, and a universal loader called xcutorsLoader.

### How do I install XCutors?

Download the release, extract it, and run the loader executable as per the installation steps.

### Do I need to disable my anticomponent?

Some anticomponent software may flag it as a false positive; you may need to add exceptions.

### Is XCutors compatible with Mac or Linux?

No, XCutors is specifically designed for Windows desktop systems only.

### How often are updates released?

Updates are released regularly to maintain compatibility with Roblox and improve features.
